...
%%
h1=figure(1)
plot(E,m_delivery_delay_E,'black+-')
hold on
plot(E,m_delivery_delay_PR1,'green+-')
hold on
plot(E,m_delivery_delay_MP,'blue+-')
hold on
plot(E,m_delivery_delay_ML,'red+-')
legend('Epidemic','PRoPHETv2','MaxProp','MinLat')
xlabel('Exchange Limit');
title('Delivery Delay');

h2=figure(2)
plot(E,m_delivery_rate_E,'black+-')
hold on
plot(E,m_delivery_rate_PR1,'green+-')
hold on
plot(E,m_delivery_rate_MP,'blue+-')
hold on
plot(E,m_delivery_rate_ML,'red+-')
legend('Epidemic','PRoPHETv2','MaxProp','MinLat')
xlabel('Exchange Limit');
title('Delivery Rate');

h3=figure(3)
plot(E,m_hop_count_E,'black+-')
hold on
plot(E,m_hop_count_PR1,'green+-')
hold on
plot(E,m_hop_count_MP,'blue+-')
hold on
plot(E,m_hop_count_ML,'red+-')
legend('Epidemic','PRoPHETv2','MaxProp','MinLat')
xlabel('Exchange Limit');
title('hop count');

h4=figure(4)
plot(E,m_buffer_occupancy_E,'black+-')
hold on
plot(E,m_buffer_occupancy_PR1,'green+-')
hold on
plot(E,m_buffer_occupancy_MP,'blue+-')
hold on
plot(E,m_buffer_occupancy_ML,'red+-')
legend('Epidemic','PRoPHETv2','MaxProp','MinLat')
xlabel('Exchange Limit');
title('buffer');
