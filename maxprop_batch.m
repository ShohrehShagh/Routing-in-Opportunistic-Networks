function [message_delivery_time]= maxprop_batch(N,destination,filename,Number_of_messages,interarrival_time,buffer_limit,exchange_limit,message_creation_node,TTL,message_creation_time)
%function [meeting_likelihood]= maxprop(N,destination,filename,Number_of_messages,interarrival_time,buffer_limit,exchange_limit,message_creation_node,TTL)
