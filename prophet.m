function [average_delivery_delay,delivery_rate,average_hop_count,average_buffer_occupancy,delivery_state_of_messages,latency_of_messages]= prophet(N,destination,filename,P_init,beta,gamma,time_step,Number_of_messages,interarrival_time,buffer_limit,exchange_limit,message_creation_node,TTL)
